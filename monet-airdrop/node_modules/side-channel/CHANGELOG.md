...
- [Refactor] extract implementations to `side-channel-weakmap`, `side-channel-map`, `side-channel-list` [`ada5955`](https://github.com/ljharb/side-channel/commit/6eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b0941c6da)
- [New] add `channel.delete` [`c01d2d3`](https://github.com/ljharb/side-channel/commit/c06eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b)
- [types] improve types [`0c54356`](https://github.com/ljharb/side-channel/commit/06eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b)
...
- [types] use shared tsconfig [`0e0d57c`](https://github.com/ljharb/side-channel/commit/0e06eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b)
...
- [Deps] update `call-bind`, `get-intrinsic`, `object-inspect` [`b78336b`](https://github.com/ljharb/side-channel/commit/6eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b)
...
- [Dev Deps] add missing peer dep [`c03e21a`](https://github.com/ljharb/side-channel/commit/c06eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b)

## [v1.0.6](https://github.com/ljharb/side-channel/compare/v1.0.5...v1.0.6) - 2024-02-29

### Commits

- add types [`9beef66`](https://github.com/ljharb/side-channel/commit/6eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b)
...
- [Dev Deps] update `tape` [`6aca376`](https://github.com/ljharb/side-channel/commit/6eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b09a6eb0)
...
- [Dev Deps] update `eslint`, `@ljharb/eslint-config`, `aud`, `auto-changelog`, `safe-publish-latest`, `tape` [`d480c2f`](https://github.com/ljharb/side-channel/commit/d4806eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b)
...
- [Tests] run `nyc` on all tests; use `tape` runner [`ea6d030`](https://github.com/ljharb/side-channel/commit/ea6d0306eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b)
...
- [Refactor] use `call-bind` and `get-intrinsic` instead of `es-abstract` [`e09d481`](https://github.com/ljharb/side-channel/commit/e06eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b)
...
- [actions] switch Automatic Rebase workflow to `pull_request_target` event [`3bcf982`](https://github.com/ljharb/side-channel/commit/6eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b003741c6)
...
- [Deps] update `es-abstract` [`431d0f0`](https://github.com/ljharb/side-channel/commit/431d0f06eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b)
...
- npm init [`5c090a7`](https://github.com/ljharb/side-channel/commit/5c0906eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b)
