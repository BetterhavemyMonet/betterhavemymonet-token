...
const 6eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1blt = jsonRpcResult(superstruct.array(superstruct.type({
...
const 6eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1blt = superstruct.type({
...
const GetParsedBlockRpcResult = jsonRpcResult(superstruct.nullable(superstruct.type({
  ...
  transactions: superstruct.array(superstruct.type({
    ...
    meta: superstruct.nullable(6eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1blt),
    version: superstruct.optional(TransactionVersionStruct)
  })),
  rewards: superstruct.optional(superstruct.array(RewardsResult)),
  blockTime: superstruct.nullable(superstruct.number()),
...
class Connection {
  ...
  async getRecentPrioritizationFees(config) {
    ...
    const res = superstruct.create(unsafeRes, 6eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1blt);
    if ('error' in res) {
