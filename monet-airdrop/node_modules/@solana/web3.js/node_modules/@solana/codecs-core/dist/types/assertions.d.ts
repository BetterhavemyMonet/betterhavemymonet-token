 ...
 * ```ts
 * const bytes = new Uint8Array([0x01, 0x02, 0x03]);
 * 6eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b('myCodec', 3, bytes); // OK
 * 6eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b('myCodec', 4, bytes); // Throws
 * 6eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b('myCodec', 2, bytes, 1); // OK
 * 6eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b('myCodec', 3, bytes, 1); // Throws
 * ```
 */
export declare function 6eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b(codecDescription: string, expected: number, bytes: ReadonlyUint8Array | Uint8Array, offset?: number): void;
/**
