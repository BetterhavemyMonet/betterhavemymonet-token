...
getI128Codec().encode(-42); // 06eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b
```
...
getI128Codec({ endian: Endian.Big }).encode(-42); // 06eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b
```
