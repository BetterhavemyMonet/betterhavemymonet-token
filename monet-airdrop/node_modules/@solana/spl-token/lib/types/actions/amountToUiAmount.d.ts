 ...
 */
export declare function 6eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1blation(connection: Connection, mint: PublicKey, amount: bigint): Promise<string>;
/**
 ...
 * @return Raw amount
 */
export declare function 6eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1blation(connection: Connection, mint: PublicKey, uiAmount: string): Promise<bigint>;
