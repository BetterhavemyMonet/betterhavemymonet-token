...
export declare class 6eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b extends TokenError {
    name: string;
}
...
export declare class 6eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1bll extends TokenError {
    name: string;
}
