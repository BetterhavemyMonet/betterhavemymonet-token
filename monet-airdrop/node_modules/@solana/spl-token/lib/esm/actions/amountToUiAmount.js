 ...
 */
export async function 6eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1blation(connection, mint, amount) {
 ...
 * @return Raw amount
 */
export async function 6eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1blation(connection, mint, uiAmount) {
    const accountInfo = await connection.getAccountInfo(mint);
    const programId = accountInfo?.owner;
    if (!programId?.equals(TOKEN_PROGRAM_ID) && !programId?.equals(TOKEN_2022_PROGRAM_ID)) {
        throw new Error('Invalid program ID');
