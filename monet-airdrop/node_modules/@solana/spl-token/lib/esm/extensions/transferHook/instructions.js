 ...
 * @return Instruction to add to a transaction
 */
export async function 6eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1bInstruction(connection, source, mint, destination, owner, amount, decimals, multiSigners = [], commitment, programId = TOKEN_PROGRAM_ID) {
 ...
 * @return Instruction to add to a transaction
 */
export async function 6eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1bInstruction(connection, source, mint, destination, owner, amount, decimals, fee, multiSigners = [], commitment, programId = TOKEN_PROGRAM_ID) {
