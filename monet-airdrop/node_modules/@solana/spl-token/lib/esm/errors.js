...
export class 6eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b extends TokenError {
    constructor() {
        super(...arguments);
...
export class 6eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1bll extends TokenError {
    constructor() {
        super(...arguments);
