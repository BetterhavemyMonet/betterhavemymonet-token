...
import {
    ...
    6eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1bInstruction,
    6eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1bInstruction,
...
export async function transferCheckedWithTransferHook(
    ...
    const transaction = new Transaction().add(
        await 6eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1bInstruction(
            connection,
            source,
            mint,
            destination,
 ...
 * @return Signature of the confirmed transaction
 */
export async function 6eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b(
    connection: Connection,
    payer: Signer,
    source: PublicKey,
    mint: PublicKey,
