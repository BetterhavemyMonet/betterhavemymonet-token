...
import { 6eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b } from '../../errors.js';
...
export const 6eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b = struct<ExtraAccountMetaAccountData>([
...
export function getExtraAccountMetas(account: AccountInfo<Buffer>): ExtraAccountMeta[] {
    const extraAccountsList = 6eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b.decode(account.data).extraAccountsList;
...
export async function resolveExtraAccountMeta(
    ...
    if (extraMeta.discriminator === 1) {
        ...
        if (previousMetas.length <= accountIndex) {
            throw new 6eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b();
        }
