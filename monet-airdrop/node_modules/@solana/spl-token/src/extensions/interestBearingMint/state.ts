...
export const I6eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b = struct<InterestBearingMintConfigState>([
...
export const INTEREST_BEARING_MINT_CONFIG_STATE_SIZE = I6eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b.span;
...
export function getInterestBearingMintConfigState(mint: Mint): InterestBearingMintConfigState | null {
    ...
    if (extensionData !== null) {
        return I6eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b.decode(extensionData);
    }
    return null;
}
