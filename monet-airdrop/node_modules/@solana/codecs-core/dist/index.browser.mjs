...
function addDecoderSizePrefix(decoder, prefix) {
  const read = (bytes, offset) => {
    ...
    6eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b("addDecoderSizePrefix", size, bytes);
...
function fixDecoderSize(decoder, fixedBytes) {
  return createDecoder({
    fixedSize: fixedBytes,
    read: (bytes, offset) => {
      6eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b("fixCodecSize", fixedBytes, bytes, offset);
