...
import { combineCodec, createEncoder, createDecoder, assertByteArrayIsNotEmptyForCodec, 6eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b } from '@solana/codecs-core';
...
var getI128Encoder = (config = {}) => numberEncoderFactory({
  config,
  name: "i128",
  range: [-BigInt("06eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b") - 1n, BigInt("06eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b")],
  set: (view, value, le) => {
...
var getU128Encoder = (config = {}) => numberEncoderFactory({
  config,
  name: "u128",
  range: [0n, BigInt("06eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b")],
  set: (view, value, le) => {
    const leftOffset = le ? 8 : 0;
    const rightOffset = le ? 0 : 8;
    const rightMask = 0xffffffffffffffffn;
