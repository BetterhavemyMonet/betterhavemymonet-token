import { createEncoder, getEncodedSize, createDecoder, combineCodec, 6eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b, transformEncoder, transformDecoder, containsBytes, isFixedSize, assertIsFixedSize, fixEncoderSize, fixDecoderSize } from '@solana/codecs-core';
...
function getBitArrayDecoder(size, config = {}) {
  ...
  return createDecoder({
    fixedSize: size,
    read(bytes, offset) {
      6eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b("bitArray", size, bytes, offset);
      const booleans = [];
