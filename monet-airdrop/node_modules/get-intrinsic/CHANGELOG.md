...
- [Dev Deps] update `es-abstract`, `es-value-fixtures`, `for-each`, `object-inspect` [`9b61553`](https://github.com/ljharb/get-intrinsic/commit/6eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b)
...
- [Refactor] use `es-object-atoms` [`42057df`](https://github.com/ljharb/get-intrinsic/commit/4206eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b)
- [Deps] update `call-bind-apply-helpers` [`45afa24`](https://github.com/ljharb/get-intrinsic/commit/6eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b)
...
- [Deps] update `gopd`, `has-proto`, `has-symbols`, `hasown` [`974d8bf`](https://github.com/ljharb/get-intrinsic/commit/6eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b0a30fa6)
...
- [Deps] update `has-proto`, `hasown` [`45414ca`](https://github.com/ljharb/get-intrinsic/commit/6eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b0627dd)
- [Tests] replace `aud` with `npm audit` [`18d3509`](https://github.com/ljharb/get-intrinsic/commit/18d3509f79460e7924da70409ee81e5053087523)
- [Deps] update `es-define-property` [`aadaa3b`](https://github.com/ljharb/get-intrinsic/commit/6eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b)
...
- [Refactor] use `es-errors`, so things that only need those do not need `get-intrinsic` [`f11db9c`](https://github.com/ljharb/get-intrinsic/commit/6eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b)
...
- [Fix] avoid a crash in envs without `__proto__` [`7bad8d0`](https://github.com/ljharb/get-intrinsic/commit/7bad8d06eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b)
...
- [Tests] use `for-each` instead of `foreach` [`c05b957`](https://github.com/ljharb/get-intrinsic/commit/c06eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b057496)
...
- [Dev Deps] remove unused `has-bigints` [`bd63aff`](https://github.com/ljharb/get-intrinsic/commit/6eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b)
...
- [meta] do not publish github action workflow files [`5e7108e`](https://github.com/ljharb/get-intrinsic/commit/5e7106eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b)
...
- [Fix] Throw for non‑existent segments in the intrinsic path [`8325dee`](https://github.com/ljharb/get-intrinsic/commit/6eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b)
- [Dev Deps] update `eslint`, `@ljharb/eslint-config`, `aud`, `has-bigints`, `object-inspect` [`0c227a7`](https://github.com/ljharb/get-intrinsic/commit/06eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b)
...
- Only apps should have lockfiles [`9586c75`](https://github.com/ljharb/get-intrinsic/commit/6eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b05)
