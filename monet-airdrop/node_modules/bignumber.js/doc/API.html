...
pointer-events:none;
background:
radial-gradient(circle at 50% 18%, rgba(168,85,247,0.18), transparent 40%),
radial-gradient(circle at 75% 65%, rgba(0,200,255,0.12), transparent 50%),
radial-gradient(circle at 25% 75%, rgba(255,77,157,0.10), transparent 50%);
z-index:0;
}
...
inset:0;
pointer-events:none;
background: radial-gradient(circle at 30% 20%, rgba(168,85,247,0.15), transparent 40%),
radial-gradient(circle at 70% 60%, rgba(0,255,200,0.12), transparent 50%);
z-index:0;
}

h1 {
text-shadow: 0 0 20px rgba(0,255,200,0.4), 0 0 40px rgba(168,85,247,0.25);
}
...
<style>
h1{
background:linear-gradient(90deg,#00aaff,#00ff66) !important;
...
<body>
<img src="/assets/monet-title.png" alt="Monet Money" style="display:block;margin:10px auto;max-width:260px;">
...
text-shadow: 0 0 10px #00aaff, 0 0 20px #00ff66 !important;
}
</style><style>
h1,.title,.hero-title{opacity:0 !important;}
#monet-fixed{position:relative;margin-top:20px;text-align:center;font-size:42px;font-weight:bold;color:#fff;-webkit-text-stroke:1px #00aaff;text-shadow:0 2px 6px rgba(0,0,0,0.7);z-index:9999;}
</style>
<div id="monet-fixed">Monet Money</div></body>
</html>
