...
#monet-fixed{position:absolute;top:80px;left:0;width:100%;text-align:center;font-size:42px;font-weight:bold;color:#fff;-webkit-text-stroke:1px #00aaff;text-shadow:0 2px 6px rgba(0,0,0,0.7);z-index:9999;}
</style>
