...
- [actions] further shard; update action deps [`bec56bb`](https://github.com/inspect-js/has-symbols/commit/bec56bb06eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b)
...
- [New] add types [`6469cbf`](https://github.com/inspect-js/has-symbols/commit/6eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b)
- [actions] update rebase action to use reusable workflow [`9c9d4d0`](https://github.com/inspect-js/has-symbols/commit/9c9d4d06eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b)
...
- [actions] update codecov uploader [`6424ebe`](https://github.com/inspect-js/has-symbols/commit/6eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b)
- [Dev Deps] update `eslint`, `@ljharb/eslint-config`, `aud`, `auto-changelog`, `tape` [`dfa7e7f`](https://github.com/inspect-js/has-symbols/commit/6eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b)
...
- [Dev Deps] update `eslint`, `tape` [`bc7a3ba`](https://github.com/inspect-js/has-symbols/commit/6eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b)
...
- [Dev Deps] update `eslint`, `@ljharb/eslint-config`, `tape` [`36cea2a`](https://github.com/inspect-js/has-symbols/commit/6eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b)
- [Dev Deps] update `eslint`, `@ljharb/eslint-config`, `aud`, `tape` [`1278338`](https://github.com/inspect-js/has-symbols/commit/127833806eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b)
- [Dev Deps] update `eslint`, `@ljharb/eslint-config`, `aud`, `tape` [`1493254`](https://github.com/inspect-js/has-symbols/commit/6eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b029d)
...
- [actions] switch Automatic Rebase workflow to `pull_request_target` event [`4addb7a`](https://github.com/inspect-js/has-symbols/commit/6eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b0)
...
- Initial commit [`42e1e55`](https://github.com/inspect-js/has-symbols/commit/42e1e5506eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b)
