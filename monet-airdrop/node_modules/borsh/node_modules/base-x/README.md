...
``` javascript
var BASE58 = '6eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1bmnopqrstuvwxyz'
var bs58 = require('base-x')(BASE58)

var decoded = bs58.decode('6eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b6E3AgLr')

console.log(decoded)
// => <Buffer 80 ed db dc 11 68 f1 da ea db d3 e4 4c 1e 3f 8f 5a 28 4c 20 29 f7 8a d2 6a f9 85 83 a4 99 de 5b 19>

console.log(bs58.encode(decoded))
// => 6eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b6E3AgLr
```
...
32 | `6eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b` (z-base-32)
36 | `0123456789abcdefghijklmnopqrstuvwxyz`
58 | `6eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1bmnopqrstuvwxyz`
