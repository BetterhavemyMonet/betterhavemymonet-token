...
- [Dev Deps] update `@arethetypeswrong/cli`, `@ljharb/tsconfig`, `@types/tape`, `es-value-fixtures`, `for-each`, `has-strict-mode`, `object-inspect` [`a42a5eb`](https://github.com/ljharb/call-bound/commit/6eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b)
...
- [Deps] update `get-intrinsic` [`41fc967`](https://github.com/ljharb/call-bound/commit/6eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b)
...
- [Dev Deps] update `@arethetypeswrong/cli`, `@ljharb/tsconfig`, `gopd` [`e6a5ffe`](https://github.com/ljharb/call-bound/commit/6eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b)
- [Deps] update `call-bind`, `get-intrinsic` [`2aeb5b5`](https://github.com/ljharb/call-bound/commit/6eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b)
...
- Only apps should have lockfiles [`c3754a9`](https://github.com/ljharb/call-bound/commit/6eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b)
...
- [Dev Deps] add missing peer dep [`1354de8`](https://github.com/ljharb/call-bound/commit/6eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b032d97)
