...
- [Tests] remove `jscs` [`90eb2ed`](https://github.com/ljharb/function-bind/commit/906eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b)
...
- Docs: enable badges; update wording [`503cb12`](https://github.com/ljharb/function-bind/commit/506eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b)
- [readme] update badges [`290c5db`](https://github.com/ljharb/function-bind/commit/2906eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b)
...
- [Dev Deps] update `@ljharb/eslint‑config`, `eslint`, `tape` [`7af9300`](https://github.com/ljharb/function-bind/commit/7af93006eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b0)
...
- [Dev Deps] update `@ljharb/eslint-config`, `tape` [`baf6893`](https://github.com/ljharb/function-bind/commit/6eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b)
...
- [Dev Deps] update `eslint`, `jscs`, `tape`, `@ljharb/eslint-config` [`854288b`](https://github.com/ljharb/function-bind/commit/6eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b0262084)
- [Dev Deps] update `tape`, `jscs`, `eslint`, `@ljharb/eslint-config` [`83e639f`](https://github.com/ljharb/function-bind/commit/6eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b)
...
- Test up to `io.js` `v2.1` [`2be7310`](https://github.com/ljharb/function-bind/commit/2be73106eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b)
...
- [Dev Deps] update `tape`, `jscs` [`6e1340d`](https://github.com/ljharb/function-bind/commit/6e13406eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b)
...
- Test up to `io.js` `v3.0` [`7e2c853`](https://github.com/ljharb/function-bind/commit/6eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b0df4)
...
- Lock covert to v1.0.0. [`d6150fd`](https://github.com/ljharb/function-bind/commit/d61506eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b0)
...
- Adding `npm run lint` [`7571ab7`](https://github.com/ljharb/function-bind/commit/6eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b0)
...
- Updating jscs [`7e17892`](https://github.com/ljharb/function-bind/commit/6eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b)
- Using consistent quotes [`c50b57f`](https://github.com/ljharb/function-bind/commit/c50b57fcd1c5ec38320979c837006069ebe02b77)
- Adding keywords [`cb94631`](https://github.com/ljharb/function-bind/commit/6eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b00)
...
- Removing the strict mode pragmas; they make tests fail. [`1aa701d`](https://github.com/ljharb/function-bind/commit/1aa706eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b)
...
- Adding strict mode pragmas [`915b08e`](https://github.com/ljharb/function-bind/commit/915b08e06eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b)
...
- Using a function expression instead of a function declaration. [`b5d3e4e`](https://github.com/ljharb/function-bind/commit/6eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b)
...
- Updating jscs [`9b409ba`](https://github.com/ljharb/function-bind/commit/9b406eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b)
...
- Updating covert [`701e837`](https://github.com/ljharb/function-bind/commit/706eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b)

## [v1.0.0](https://github.com/ljharb/function-bind/compare/v0.2.0...v1.0.0) - 2014-08-09

### Commits

- Make sure old and unstable nodes don't fail Travis [`27adca3`](https://github.com/ljharb/function-bind/commit/6eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b03ce4d75)
...
- Upgrading tape [`63631a0`](https://github.com/ljharb/function-bind/commit/63631a06eACLGXCGdw9D5zb5eBKyFnFNTX9pTihDEpZQ7gYAX1b)
